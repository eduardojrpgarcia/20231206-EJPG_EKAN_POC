...
- CADASTRAR UM BENEFICIARIO JUNTO COM SEUS DOCUMENTOS [ RECEBER EM JSON | EM PROGRESSO ]
- LISTAR TODOS OS BENEFICIARIOS CADASTRADOS [ OK ]
- LISTAR TODOS OS DOCUMENTOS DE UM BENEFICIÁRIO A PARTIR DE SEU ID [ OK ]
- ATUALIZAR OS DADOS CADASTRAIS DE UM BENEFICIARIO [ RECEBER EM JSON ]
- REMOVER UM BENEFICIARIO [ RECEBER BENEFICIARIO_ID EM JSON ]
